...
RH_bad = 0.70  # 80% for Bad scenario
...
# Display the first 10 SH values for each scenario for Trondheim and Rome
print("Specific Humidity for Good scenario (First 10) - Trondheim:\n", df_trondheim['SH_Good'].head(10))
print("Specific Humidity for Average scenario (First 10) - Trondheim:\n", df_trondheim['SH_Average'].head(10))
print("Specific Humidity for Bad scenario (First 10) - Trondheim:\n", df_trondheim['SH_Bad'].head(10))

print("Specific Humidity for Good scenario (First 10) - Rome:\n", df_rome['SH_Good'].head(10))
print("Specific Humidity for Average scenario (First 10) - Rome:\n", df_rome['SH_Average'].head(10))
print("Specific Humidity for Bad scenario (First 10) - Rome:\n", df_rome['SH_Bad'].head(10))
